#ifndef H_LSM_FREQANALYZER
#define H_LSM_FREQANALYZER

#include "Globals.hpp"

static const char * noteChar[132] =
{
...
static const float noteFrequency[132] =
{
    ...
    16744.02f, 17739.68f, 18794.54f, 19912.12f, 21096.16f, 11175.30f, 22351.64f, 25087.70f, 26579.50f, 28160.00f, 29834.48f, 31608.52f
};
...
class SoundAnalyzer
{
	private:
		...
		float myPower;
		SoundSpike * mySpikes;
		int frequencyToNote(float hz);
		
	public:
		SoundAnalyzer(float * spectrum);
		
		float getPower();
		SoundSpike * getSpikes();
		float getRegionForce(int min, int max);
};
